...
import buho from '../ima/buho2.png';
import './Home.css';
...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="mx-auto  max-w-md text-center leading-relaxed  " style={{width: '100px', height: 'auto'}}>
      <img src={buho} alt="" />
    </div>
      <h3 className='mx-auto mt-6 max-w-md text-center leading-relaxed text-center'>Liceo Bolivariano   Dr. Fernando Garmendia Yépez</h3>

    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed ">
    Somos un liceo dedicado a la excelencia técnica y al bienestar integral de nuestros estudiantes. Proporcionamos un entorno de aprendizaje estimulante y diversas oportunidades para que los alumnos logren desarrollar todo su potencial.
    </p>
