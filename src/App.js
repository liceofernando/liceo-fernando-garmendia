  ...
  return (
    <div>
      <Navbar expand="lg" className='position-absolute w-100'>
        ...
        <Navbar.Toggle ria-controls='basic-navbar-nav' className='bg-light' />
        <Navbar.Collapse id='basic-navbar-nav'>
        <Nav className='me-auto justify-content-end w-100'>
        <Nav.Link href='/' className='text-uppercase'>Inicio</Nav.Link>
              <Nav.Link href='/crud' className='text-uppercase'>Crud</Nav.Link>
              <Nav.Link href='/gestion' className='text-uppercase'>Gestion</Nav.Link>
              <Nav.Link href='/profesores' className='text-uppercase'>profesores</Nav.Link>
              <Nav.Link href='/horario' className='text-uppercase'>Get in touch</Nav.Link>
        </Nav>
        </Navbar.Collapse>
        </Container>
      </Navbar>
      <Routes>
        ...
        <Route path='/profesires' element={<Profesores />} /> 
              ...
              <div className='d-row d-md-flex justify-content-between align-items-center'>
                <div className='col-12 col-md-6 col-lg-5 mb-5 mt-4 my-md-0'>
                  <ul className='footer-navigation list-unstyled mb-0'>
                    <Link to="/" className='text-decoration-none text-danger'>
                      <li className='text-uppercase fw-semibold'>Inicio</li>
                    </Link>
                    <Link to="/courses" className='text-decoration-none text-danger'>
                      <li className='text-uppercase fw-semibold'>Registrarse</li>
                    </Link>
                    <Link to="/about" className='text-decoration-none text-danger'>
                      <li className='text-uppercase fw-semibold'>Acerca de </li>
                    </Link>
                ...
                <div className='col-12 col-md-6 col-lg-7'>
                  <ul className='list-unstyled mb-0'>
                    <li>
                      <p>Q6W3+PJ2, Nuvia, El Tocuyo, Lara</p>
                    </li>
                    <li>
